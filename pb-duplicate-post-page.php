 ...
 */
define( 'PBDPP_DUPLICATE_POST_PAGE_VERSION', '1.0.0' );
 ...
 */
function pbdpp_update_plugin_row_meta( $plugin_meta, $plugin_file ) {
...
add_filter( 'plugin_row_meta', 'pbdpp_update_plugin_row_meta', 10, 2 );
 ...
 */
function pbdpp_duplicate_post_as_draft() {
	global $wpdb;
...
add_action( 'admin_action_duplicate_post_as_draft', 'pbdpp_duplicate_post_as_draft' );
 ...
 */
function pbdpp_duplicate_post_link( $actions, $post ) {
...
add_filter( 'post_row_actions', 'pbdpp_duplicate_post_link', 10, 2 );
add_filter( 'page_row_actions', 'pbdpp_duplicate_post_link', 10, 2 );
